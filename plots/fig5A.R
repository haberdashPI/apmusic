...
df = read.csv(file.path("preprocessing","data",fig5A_data))
model = read.csv(file.path("preprocessing","data",fig5A_model))
...
file = file.path("plots","pdfs",paste("fig5A_",Sys.Date(),".pdf",sep=""))
