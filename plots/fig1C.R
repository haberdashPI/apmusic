...
rdata = read.csv(file.path("preprocessing","data",fig1C_data))
rmodel = read.csv(file.path("preprocessing","data",fig1C_model))
...
file = file.path('plots','pdfs',paste('fig1C_',Sys.Date(),'.pdf',sep=''))
